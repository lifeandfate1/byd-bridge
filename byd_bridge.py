...
def parse_ac_xml(path: str) -> Dict[str, Any]:
    ...
    if btn is not None: # FIX D: Deprecation warning fix
...
# ==============================================================================
# Helper functions for Scroll and Reset (Fix A & C)
# ==============================================================================
...
def main():
    ...
    while True:
        ...
        t0 = time.time()
        try:
            # FIX A: Ensure state is clean before starting tasks
            ensure_home_page_reset(adb)
